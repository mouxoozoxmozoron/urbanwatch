            ...
            <div class="container px-0">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-8">
                            <div class="topbar-info d-flex flex-wrap">
                                <a href="mailto:urbanwatch@aftarkeianet.com" class="text-light me-4"><i class="fas fa-envelope text-white me-2"></i>urbanwatch@aftarkeianet.com</a>
                ...
                <nav class="navbar navbar-light bg-light navbar-expand-xl">
                    <a href="index.html" class="navbar-brand ms-3">
                        <h1 class="text-primary display-5">UrbanWatch</h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse bg-light" id="navbarCollapse">
                        <div class="navbar-nav ms-auto">
                            ...
                            <a href="events.html" class="nav-item nav-link">Upcoming Events</a>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="donation.html" class="dropdown-item">Make a Donation</a>
        ...
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item">
                    <h4 class="mb-4 text-white">Stay Informed</h4>
                    <p class="mb-4">Subscribe to get updates on smart city innovations, infrastructure analytics, and real-time urban insights from UrbanWatch.</p>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    <h4 class="mb-4 text-white">Our Contributors</h4>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Jane Mwita</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> David Mwakalinga</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Michael Komba</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Amina Yusuf</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> John Mushi</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Neema Aloyce</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item">
                    <h4 class="mb-4 text-white">Insight Gallery</h4>
                    <div class="row g-2">
                        @for ($i = 1; $i <= 6; $i++)
                        <div class="col-4">
                            <div class="footer-gallery">
                                <img src="{{ asset('front/img/gallery-footer-' . $i . '.jpg') }}" class="img-fluid w-100" alt="Urban Insight Image {{ $i }}">
                                <div class="footer-search-icon">
                                    <a href="{{ asset('front/img/gallery-footer-' . $i . '.jpg') }}" data-lightbox="footerGallery-{{ $i }}" class="my-auto">
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-4 text-center text-md-start mb-md-0">
                <span class="text-body"><i class="fas fa-copyright text-light me-2"></i>UrbanWatch</span>, All rights reserved.
            </div>
            ...
            <div class="col-md-4 text-center text-md-end text-body">
                Designed & Developed by the UrbanWatch Team
            </div>
        </div>
    </div>
</div>
